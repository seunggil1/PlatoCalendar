...
class _ToDoList extends State<ToDoList> {
  ...
  Widget build(BuildContext context) {
    ...
    icsList.forEach((element) {
      ...
      if (dropdownValue == '전체' ||
          element.classCode == dropdownValue) if (!element.disable) {
        // 유저가 삭제 처리
        if (element.finished) {
          // 완료 일정
          ...
          // 날짜 정보 없음
          if (element.end == null)
            toDoListNodate.add(_getTodoWidget(element));
          else if (diff.inSeconds < 0) // 기간 지남
            toDoListPassed.add(_getTodoWidget(element));
          else if (diff.inDays > 7) {
            // 일주일 이상 남음.
            toDoListLongTime.add(_getTodoWidget(element));
          } else if (element.end.day == now.day) {
            //오늘 까지
          ...
          } else if (element.end.day ==
              now.add(const Duration(days: 1)).day) // 내일까지
        ...
        children: [
          toDoListPassed.isEmpty
              ...
              : Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_getDurationWidget("지난 할일", 0)] +
                        (UserData.showToDoList[0] ? toDoListPassed : []),
                  ),
                ),
          toDoList6Hour.isEmpty
              ? Container()
              : Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_getDurationWidget("6시간 이내", 1)] +
                        (UserData.showToDoList[1] ? toDoList6Hour : []),
                  ),
                ),
          toDoList12Hour.isEmpty
              ? Container()
              : Container(
                  margin: edgeInsetsMiddle,
                  padding: const EdgeInsets.symmetric(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_getDurationWidget("12시간 남음", 2)] +
                        (UserData.showToDoList[2] ? toDoList12Hour : []),
                  ),
                ),
          toDoListToday.isEmpty
              ? Container()
              : Container(
                  margin: edgeInsetsMiddle,
                  padding: const EdgeInsets.symmetric(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_getDurationWidget("오늘", 3)] +
                        (UserData.showToDoList[3] ? toDoListToday : []),
                  ),
                ),
          toDoListTomorrow.isEmpty
              ? Container()
              : Container(
                  margin: edgeInsetsMiddle,
                  padding: const EdgeInsets.symmetric(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_getDurationWidget("내일", 4)] +
          ...
          toDoListWeek.isEmpty
              ...
              : Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_getDurationWidget("7일 이내", 5)] +
                        (UserData.showToDoList[5] ? toDoListWeek : []),
                  ),
                ),
          toDoListLongTime.isEmpty
              ? Container()
              : Container(
                  margin: edgeInsetsMiddle,
                  padding: const EdgeInsets.symmetric(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_getDurationWidget("7일 이상", 6)] +
                        (UserData.showToDoList[6] ? toDoListLongTime : []),
                  ),
                ),
          toDoListNodate.isEmpty
              ? Container()
              : Container(
                  margin: edgeInsetsMiddle,
                  padding: const EdgeInsets.symmetric(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_getDurationWidget("기한 없음", 7)] +
                        (UserData.showToDoList[7] ? toDoListNodate : []),
                  ),
                ),
          toDoListFinished.isEmpty
              ? Container()
              : Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_getDurationWidget("완료", 8)] +
                        (UserData.showToDoList[8] ? toDoListFinished : []),
                  ),
                ),
        ],
      ),
  ...
  Widget _getDurationWidget(String str, int index) {
    return Container(
        ...
        child: GestureDetector(
            ...
            onTap: () {
              setState(() {
                UserData.showToDoListByIndex(
                    index, !UserData.showToDoList[index]);
              });
            },
            child: Row(
                    ...
                    text: TextSpan(
                        style: TextStyle(color: () {
                          if (UserData.themeMode == ThemeMode.dark)
                            return Colors.white;
                          else if (UserData.themeMode == ThemeMode.system &&
